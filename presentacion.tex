...
\frame{
	...
	\item Incorporar datos realistas del tráfico para considerar rutas alternativas.
	\item Incorporar datos en tiempo real de la disponibilidad de los taxis.
	\item Mejorar la experiencia de los usuarios en el planificador de viajes compartidos.
	\item Desarrollar versiones para dispositivos móviles Android y Windows Phone.
	\item Soportar la variante multiobjetivo en el planificador de viajes compartidos.
