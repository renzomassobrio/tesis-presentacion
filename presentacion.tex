...
\frame{
	\frametitle{Modelos paralelos en AE}
	\begin{block}{Descripción}
	...
	\begin{block}{
		...
		\begin{columns}
			\column{0.6\textwidth}
			\begin{itemize}
				\item Los AE con subpoblaciones distribuidas suelen perder diversidad, convergiendo a soluciones sub-óptimas del problema.
