...
\frame{
	...
	Ma et al. (2013) TPP dinámico con pedidos en tiempo real.\\ \hspace{1cm}{\small 13\% de ahorro en distancia con un algoritmo ávido en \textbf{instancias realistas}.}\pause
	\end{block}
	\pause
	\begin{block}{Resumen}
