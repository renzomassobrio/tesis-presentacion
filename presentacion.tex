...
\frame{
	...
	\begin{itemize}
		...
		\item Una función de distancia, $dist: \lbrace \lbrace O \rbrace \cup D \rbrace \times D \rightarrow \mathbb{R}^+_0$, y una función de costo asociado a la distancia, $cost: \mathbb{R}^+_0 \rightarrow \mathbb{R}^+_0$.
...
\frame{
	...
	\pause
		...
		%\begin{itemize}
			\item Se consideran vehículos con \alert{diferentes capacidades}.\pause
...
\frame{
	...
	\begin{itemize}
	\item Se relevó la literatura relacionada, se presentaron \textbf{dos} variantes del problema y se implementaron \textbf{cuatro} AE.\pause
...
\frame{
	...
	\begin{itemize}
		...
		\item Incorporar \textbf{datos realistas del tráfico}.\pause
	...
	\begin{itemize}
		\item Mejorar la experiencia de usuario.\pause
