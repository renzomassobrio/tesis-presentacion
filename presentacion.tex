...
\frame{
	...
	Se alcanzaron mejores valores en \textbf{todas} las instancias. En el mejor caso se superó el costo en un \alert{35.9\%}.
	\input{./evaluacion_experimental/mejoras_greedy_clei/imagenes.tex}
}

\frame{
	\frametitle{Mejora \textit{p$\mu$EA} sobre algoritmo ávido}
	Se alcanzaron mejores valores en \textbf{todas} las instancias. En el mejor caso se superó el costo en un \alert{41\%}.
